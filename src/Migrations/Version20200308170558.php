 ...
 */
final class Version20200308170558 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE discovery (id INT AUTO_INCREMENT NOT NULL, continent_id INT NOT NULL, name VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(50) NOT NULL, slug VARCHAR(150) NOT NULL, INDEX IDX_54380C2F921F4C77 (continent_id), INDEX idx_discovery_slug (slug), UNIQUE INDEX uniq_discovery_name (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
